...
unconditioned_generation_consts = Namespace(
    path=path,
    workdir=workdir,
    proc_dataset_csv=path/'surnames_with_splits.csv',
    model_dir=workdir/'models',
    vectorizer_json=workdir/'unconditioned_generation_vectorizer.json',
    metrics_file=workdir/'unconditioned_generation_metrics.csv',
    class_weights_pth=workdir/'class_weights.pth',
    char_embedding_sz=100,
    rnn_hidden_sz=64,
    bs=64,
